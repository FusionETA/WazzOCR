...
- Malaysian LHDN stamp duty forms: if "Nama Surat Cara" / instrument name is "Letter of Guarantee", choose the company named as "Nama Pihak Pertama" / the employer / "Company Name" on the Letter of Guarantee as billedTo. Do NOT use "Nama Syarikat/Firma/Agensi" as billedTo; that is the submitter/applicant firm for the stamp duty filing, not necessarily the entity the cost belongs to. "Nama Pihak Kedua" / IPA / PT name is the counterparty, not billedTo.
